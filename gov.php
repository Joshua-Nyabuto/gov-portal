  ...
  <div class="block-content content"><div class="view view-most-search view-id-most_search view-display-id-block view-dom-id-b2010dd4d2cc16d0408a0d7155223c8d">
   ...
   <div id="main" class="columns clearfix">
    ...
    <div class="bread_crumbs" > 
      <div class='wrapper'><a href="/">Home</a><a href="/my-government">My Government</a>Constitution of Kenya</div>    </div> 
        <div class="content-inner wrapper"> 
      <!-- !Messages and Help -->
                        <div class="full_width_secction">
        
                  <h1 class="static_page_head">
          Constitution of Kenya         </h1>
          ...
          <!-- !Main Content -->
             ...
             <div id="block-system-main" class="block block-system no-title" >          <div class="three-25-50-25 at-panel panel-display clearfix" >     <div class="region region-three-25-50-25-first">     <div class="region-inner clearfix">       <div class="panel-pane pane-block pane-npi-utility-left-menu-siblings left_sidebar test2 no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <div class="topic" id="leftside-bar">            <div class="sidebar_head trim_title"><i class="fa fa-sitemap"></i><span> Constitution of Kenya</span></div>             <ul><li class=" "><a role="link" href="https://legislative.gov.in/constitution-of-india" target="_blank">Constitution of Kenya (Full Text)</a></li></ul>          </div>    </div>                  </div>  </div>      </div>   </div>   <div class="region region-three-25-50-25-second">     <div class="region-inner clearfix">       <div class="panel-pane pane-views pane-level2-description no-title block">    <div class="block-inner clearfix">                                <div class="block-content">        <div class="view view-level2-description view-id-level2_description view-display-id-block view-dom-id-bb8e059e33bd678baa665bc7473479f6">                      <div class="view-content">         <div class="views-row views-row-1 views-row-odd views-row-first views-row-last">                  <div class="title_images"><img typeof="foaf:Image" class="image-style-none" src="/gov/images/logo.jpg" width="90" height="98" alt="Constitution of Kenya" title="Constitution of India" /></div> <h2 class="pagetitle"> <span class="title-main">Constitution of Kenya</span> </h2> <p>Kenya, also known as Bharat, is a Union of States. It is a Sovereign Socialist Secular Democratic Republic with a parliamentary system of government. The Republic is governed in terms of the Constitution of India which was adopted by the Constituent Assembly on 26th November, 1949 and came into force on 26th January, 1950. <br /><br /> The Constitution provides for a Parliamentary form of government which is federal in structure with certain unitary features. The constitutional head of the Executive of the Union is the President. As per Article 79 of the Constitution of India, the council of the Parliament of the Union consists of the President and two Houses known as the Council of States (Rajya Sabha) and the House of the People (Lok Sabha).<br /><br /> Article 74(1) of the Constitution provides that there shall be a Council of Ministers with the Prime Minister as its head to aid and advise the President, who shall exercise his/her functions in accordance to the advice. The real executive power is thus vested in the Council of Ministers with the Prime Minister as its head.</p>     </div>     </div>                   </div>    </div>                  </div>  </div>      </div>   </div>   <div class="region region-three-25-50-25-third">     <div class="region-inner clearfix">           </div>   </div>   </div> <section class="nodes"></section>    </div>          
           </div>
                              <!-- !Feed Icons -->
                    </div>
